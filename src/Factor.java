...
//                    int thisIndex = this.vars.indexOf(var.name);
//                    int otherIndex = other.vars.indexOf(var.name);
...
//                            newRow[k] = thisLine[this.vars.indexOf(newVar.name)];
//                        } else if (other.vars.contains(newVar.name)) {
//                            newRow[k] = otherLine[other.vars.indexOf(newVar.name)];
//                        }
//                    }
//
//                    // Multiply the probabilities
